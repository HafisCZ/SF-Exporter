...
TABLE_EXPRESSION_CONFIG.register(
  ...
  {
    expr: (obj) => fetchPlayerGroupValue(obj, () => (obj.Group?.Group?.TotalTreasure || 0) + 2 * Math.min(obj.Dungeons.Raid, 50), () => obj.TotalTreasure + 2 * Math.min(obj.Raid, 50)),
  }
)
...
TABLE_EXPRESSION_CONFIG.register(
  ...
  {
    expr: (obj) => fetchPlayerGroupValue(obj, () => (obj.Group?.Group?.TotalInstructor || 0) + 2 * Math.min(obj.Dungeons.Raid, 50), () => obj.TotalInstructor + 2 * Math.min(obj.Raid, 50)),
  }
)
