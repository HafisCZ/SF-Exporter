...
class ItemModel {
    ...
    getScrapbookPosition () {
        let boundary_start = _dig(ItemModel.SCRAPBOOK_BOUNDARIES, this.ColorClass, this.Type - 1, this.IsEpic ? 1 : 0);
...
class ModelUtils {
    ...
    static toOtherGroup (group) {
        ...
        for (const field of this.#CONVERT_OTHER_GROUP_FIELDS) {
    ...
    static toOtherPlayer (player) {
        ...
        for (const field of this.#CONVERT_OTHER_PLAYER_FIELDS) {
